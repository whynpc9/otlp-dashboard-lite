 ...
 */
export declare const file_opentelemetry_proto_collector_trace_v1_trace_service: GenFile;

/**
 * @generated from message opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest
 */
export declare type ExportTraceServiceRequest = Message<"opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest"> & {
  /**
 ...
 */
export declare const ExportTraceServiceRequestSchema: GenMessage<ExportTraceServiceRequest>;

/**
 * @generated from message opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse
 */
export declare type ExportTraceServiceResponse = Message<"opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse"> & {
  /**
 ...
 */
export declare const ExportTraceServiceResponseSchema: GenMessage<ExportTraceServiceResponse>;

/**
 * @generated from message opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess
 */
export declare type ExportTracePartialSuccess = Message<"opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess"> & {
  /**
 ...
 */
export declare const ExportTracePartialSuccessSchema: GenMessage<ExportTracePartialSuccess>;
 ...
 */
export declare const TraceService: GenService<{
  /**
